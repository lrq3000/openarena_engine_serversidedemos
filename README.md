...
**IMPORTANT NOTE: For the latest patch, compiled only on ioquake3 (release 2017-03-04), v1.1.0 with a few additional bugfixes (here the last version is 1.0.0), see https://github.com/lrq3000/ioq3/tree/server-side-demo**
