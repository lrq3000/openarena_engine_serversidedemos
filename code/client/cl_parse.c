...
void CL_SystemInfoChanged( void ) {
	...
	while ( s ) {
		...
		else
		{
			...
			// I have added exceptions for sv_fps, pmove_fixed and pmove_msec. These should relly be corrected in the game logic code, but they are required\
				for a lot of mods and not all can be changed. vq3 uses pmove_fixed, pmove_msec and g_synchronousClients. Most unlagged mods uses sv_fps too.
